...
import { securityAND, securityOR, oauth2Requirement, oauth2Security } from "../dsl/security.ts"
...
const Channel = () =>
  ({
    ...
    properties: {
      ...
      localizations: dict(({ type: "string" } as const), ChannelLocalization, { description: "Localizations for different languages" }),
...
const ChannelSection = () =>
  ({
    properties: {
      ...
      localizations: dict(({ type: "string" } as const), ChannelSectionLocalization, { description: "Localizations for different languages" }),
...
const Playlist = () =>
  ({
    ...
    properties: {
      ...
      localizations: dict(({ type: "string" } as const), PlaylistLocalization, { description: "Localizations for different languages" }),
...
const Video = () =>
  ({
    ...
    properties: {
      ...
      localizations: dict(({ type: "string" } as const), VideoLocalization, { description: "The localizations object contains localized versions of the basic details about the video, such as its title and description." }),
...
const __xgafv = named("_.xgafv", queryParam({
...
const access_token = named("access_token", queryParam({
...
const alt = named("alt", queryParam({
...
const callback = named("callback", queryParam({
  description: "JSONP",
  in: "query",
  name: "callback",
  schema: ({
...
const fields = named("fields", queryParam({
...
const key = named("key", queryParam({
...
const oauth_token = named("oauth_token", queryParam({
...
const prettyPrint = named("prettyPrint", queryParam({
...
const quotaUser = named("quotaUser", queryParam({
...
const uploadType = named("uploadType", queryParam({
...
const upload_protocol = named("upload_protocol", queryParam({
...
export default responsibleAPI({
  ...
  forAll: {
    req: {
      params: [__xgafv, access_token, alt, callback, fields, key, oauth_token, prettyPrint, quotaUser, uploadType, upload_protocol],
    },
  },
  routes: {
    "/youtube/v3/abuseReports": POST(({
      ...
      req: {
        ...
        security: youtubeScopes("https://www.googleapis.com/auth/youtube", "https://www.googleapis.com/auth/youtube.force-ssl"),
        body: ({
    ...
    "/youtube/v3/activities": GET(({
      ...
      req: {
        ...
        security: youtubeScopes("https://www.googleapis.com/auth/youtube", "https://www.googleapis.com/auth/youtube.force-ssl", "https://www.googleapis.com/auth/youtube.readonly")
      },
      res: {
        "200": response({
          description: "Successful response",
    ...
    "/youtube/v3/captions": scope({
      ...
      DELETE: ({
        ...
        req: {
          ...
          security: youtubeScopes("https://www.googleapis.com/auth/youtube.force-ssl", "https://www.googleapis.com/auth/youtubepartner")
        },
        res: {
          "200": response({
            description: "Successful response"
    ...
    "/youtube/v3/channelBanners/insert": POST(({
      ...
      req: {
        ...
        security: youtubeScopes("https://www.googleapis.com/auth/youtube", "https://www.googleapis.com/auth/youtube.force-ssl", "https://www.googleapis.com/auth/youtube.upload"),
        body: ({
    ...
    "/youtube/v3/channelSections": scope({
      ...
      DELETE: ({
        ...
        req: {
          ...
          security: youtubeScopes("https://www.googleapis.com/auth/youtube", "https://www.googleapis.com/auth/youtube.force-ssl", "https://www.googleapis.com/auth/youtubepartner")
        },
        res: {
          "200": response({
            description: "Successful response"
      ...
      GET: ({
        ...
        req: {
          ...
          security: youtubeScopes("https://www.googleapis.com/auth/youtube", "https://www.googleapis.com/auth/youtube.force-ssl", "https://www.googleapis.com/auth/youtube.readonly", "https://www.googleapis.com/auth/youtubepartner")
        },
        res: {
          "200": response({
            description: "Successful response",
    ...
    "/youtube/v3/channels": scope({
      ...
      GET: ({
        ...
        req: {
          ...
          security: youtubeScopes("https://www.googleapis.com/auth/youtube", "https://www.googleapis.com/auth/youtube.force-ssl", "https://www.googleapis.com/auth/youtube.readonly", "https://www.googleapis.com/auth/youtubepartner", "https://www.googleapis.com/auth/youtubepartner-channel-audit")
        },
        res: {
          "200": response({
            description: "Successful response",
    ...
    "/youtube/v3/commentThreads": scope({
      ...
      GET: ({
        ...
        req: {
          ...
          security: youtubeScope("https://www.googleapis.com/auth/youtube.force-ssl")
        },
        res: {
          "200": response({
            description: "Successful response",
    ...
    "/youtube/v3/members": GET(({
      ...
      req: {
        ...
        security: youtubeScope("https://www.googleapis.com/auth/youtube.channel-memberships.creator")
      },
      res: {
        "200": response({
          description: "Successful response",
    ...
    "/youtube/v3/tests": POST(({
      ...
      req: {
        ...
        security: youtubeScope("https://www.googleapis.com/auth/youtube.readonly"),
        body: ({
    ...
    "/youtube/v3/thumbnails/set": POST(({
      ...
      req: {
        ...
        security: youtubeScopes("https://www.googleapis.com/auth/youtube", "https://www.googleapis.com/auth/youtube.force-ssl", "https://www.googleapis.com/auth/youtube.upload", "https://www.googleapis.com/auth/youtubepartner")
      },
      res: {
        "200": response({
          description: "Successful response",
